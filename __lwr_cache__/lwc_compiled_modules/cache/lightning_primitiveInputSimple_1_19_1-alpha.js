...
import { calculateFractionDigitsFromStep, formatNumber, fromIsoDecimal, hasValidNumberShortcut, hasValidNumberSymbol, increaseNumberByStep, isValidNumber, isValidNumberCharacter, stringifyNumber, toIsoDecimal } from 'lightning/inputUtils';
...
class LightningPrimitiveInputSimple extends LightningShadowBaseClass {
  get ariaDescribedByElements() {
    const lable = this._helpMessage ? this.template.querySelector('[data-form-label]') : null;
...
_registerDecorators(LightningPrimitiveInputSimple, {
  ...
  publicMethods: ["getDisplayedValue"],
  fields: ["_formatter", "_showRawNumber", "_initialValueSet", "_rendered", "_selectionCache", "_helpMessage", "_step", "_numberRawValue", "_value"]
});

...
import _tmpl from "./certification.html";
import "@lwc/synthetic-shadow";
class Experience extends LightningElement {
  constructor(...args) {
    super(...args);
    this.BASEURL = "/public/assets/certificationlogo/";
    this.format = "web";
    this.certifications = [{
      ...
      certName: "Salesforce Certified Tableau CRM and Einstein Discovery Consultant",
      certNumber: "3557354",
      hascertNumber: true,
      hasissueDate: true,
      issueDate: "July 2023",
...
_registerDecorators(Experience, {
  ...
  fields: ["BASEURL", "certifications"]
});
export default _registerComponent(Experience, {
  tmpl: _tmpl,
  sel: "resume-certification",
  apiVersion: 59
});
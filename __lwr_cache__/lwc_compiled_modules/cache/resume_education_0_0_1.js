...
class Education extends LightningElement {
  constructor(...args) {
    ...
    this.education = [{
      ...
      hasAchievement: true,
      achievements: ["Worked with the Graphics team of the Anual Fest and helped them create the visuals for the Stage.", "Developed one of the best Computer Science Project based on Java and Concepts of OOPs"]
    }, {
      institute: "Laurels School International",
      degree: "10th ICSE (Indian Certificate of Secondary Education)",
      duration: "June 2010 - June 2013",
      hasAchievement: true,
      achievements: ["Achieved A Grade in German Language", "Worked with the Anual Fest team of students and managed the dances & shows from the backend."]
    }];
    this.timeline = [{
      institute: "Laurels School International",
      duration: "June 2010 - June 2013",

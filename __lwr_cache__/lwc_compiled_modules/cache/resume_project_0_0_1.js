...
class Project extends LightningElement {
  constructor(...args) {
    ...
    this.projects = [{
      ...
      difficulties: ["Adapting to the nuanced requirements of various B2B industries during CPQ solution design", "Seamlessly integrating diverse Salesforce technologies to optimize the quotation process", "Ensuring the responsiveness and intuitiveness of user interfaces amidst complex data flows"],
      majorFunctionalities: ["Dynamic Industries CPQ solutions tailored to the Communications Industry", "Enhanced user engagement via responsive Lightning Components and Community", "Streamlined navigation experience with OmniScripts"],
      ...
      difficulties: ["Transforming traditional production tracking and inventory management systems", "Merging legacy interfaces with Salesforce Experience Cloud for an upgraded order placement experience", "Ensuring seamless integration while preserving data integrity across systems"],
      majorFunctionalities: ["Real-time production tracking and advanced inventory management", "Unified and intuitive order placement interface through Experience Cloud", "Cross-functional collaboration tools for integrated solution development"],
      ...
      difficulties: ["Automating the multifaceted complaint management backend operations", "Streamlining Salesforce administrative tasks for a diverse user base"],
      majorFunctionalities: ["An automated backend complaint resolution process", "Customized Salesforce permissions and record visibility for tailored user experiences"],
      ...
      difficulties: ["Migrating a vast user base from Salesforce Classic to Lightning without disrupting daily operations", "Ensuring the precision of complex financial transaction processes", "Designing a scalable and efficient data archiving strategy amidst growing datasets"],
      majorFunctionalities: ["User-friendly payment portals for a seamless transaction experience", "Custom dashboards tailored to financial teams for tracking and managing opportunities", "Dynamic decision-making tools adaptable to evolving business requirements"],
      ...
      clouds: ["SALES CLOUD"],
      difficulties: ["Integrating diverse event management workflows into a unified system", "Achieving seamless interoperability with Current RMS", "Customizing client quote generation to cater to varied event types"],
      majorFunctionalities: ["End-to-end event planning and execution workflow", "Real-time availability checks for event resources", "Automated client communication channels for event updates and notifications"],
      ...
      clouds: ["OMNISTUDIO", "SALES CLOUD", "EXPERIENCE CLOUD"],
      difficulties: ["Navigating Facebook's evolving API standards", "Ensuring GDPR compliance for user data", "Achieving a balance between functionality and AppExchange compliance."],
      majorFunctionalities: ["Facebook Ad Campaign creation and management", "Performance analytics dashboard", "Real-time sync of Ad engagement metrics"],

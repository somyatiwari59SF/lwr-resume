...
@supports (--styling-hooks: '') {
    ...
    :host([data-render-mode="shadow"]) [part="accordion-section"] {
        padding-block-start: var(--slds-c-accordionsection-spacing-blockstart, var(--sds-g-spacing-3, 0.75rem));
        padding-block-end: var(--slds-c-accordionsection-spacing-blockend, var(--sds-g-spacing-3, 0.75rem));
        padding-inline-end: var(--slds-c-accordionsection-spacing-inlineend, var(--sds-g-spacing-3, 0.75rem));
        padding-inline-start: var(--slds-c-accordionsection-spacing-inlinestart, var(--sds-g-spacing-3, 0.75rem));
    }
    ...
    :host([data-render-mode="shadow"]) .slds-accordion__summary {
        ...
        var(--sds-g-sizing-4, 0.75rem) * -1));
        padding-block-start: var(--slds-c-accordionsection-spacing-blockstart, var(--sds-g-sizing-4, 0.75rem));
        padding-block-end: var(--slds-c-accordionsection-spacing-blockend, var(--sds-g-sizing-4, 0.75rem));
        padding-inline-end: var(--slds-c-accordionsection-spacing-inlineend, var(--sds-g-sizing-4, 0.75rem));
        padding-inline-start: var(--slds-c-accordionsection-spacing-inlinestart, var(--sds-g-sizing-4, 0.75rem));
    ...
    :host([data-render-mode="shadow"]) [part="button"] {
        ...
        margin-block-start: calc(
          var(--slds-c-accordionsection-spacing-blockstart, var(--sds-g-sizing-4, 0.75rem)) * -1);

<template>
    <svg class={computedClass} focusable="false" data-key={name} aria-hidden="true" viewBox="0 0 56 64" part="icon">
        <g>
 <path d="M5.106 0A5.074 5.074 0 00.033 5.074v53.841a5.073 5.073 0 005.073 5.074H50.88a5.074 5.074 0 005.074-5.074V20.31L37.051 0H5.106z" fill-rule="evenodd" clip-rule="evenodd" fill="#2E844A"></path>
 ...
 <g fill-rule="evenodd" clip-rule="evenodd">
  <path d="M56.001 20.357v1h-12.8s-6.312-1.26-6.128-6.707c0 0 .208 5.707 6.003 5.707h12.925z" fill="#194E31"></path>
  <path d="M37.098.006v14.561c0 1.656 1.104 5.791 6.104 5.791h12.8L37.098.006z" fill="#CDEFC4"></path>
 </g>
</g>
    </svg>
</template>

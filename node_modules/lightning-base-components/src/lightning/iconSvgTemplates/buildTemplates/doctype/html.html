<template>
    <svg class={computedClass} focusable="false" data-key={name} aria-hidden="true" viewBox="0 0 56 64" part="icon">
        <g>
 <path d="M5.135.008A5.074 5.074 0 00.061 5.082v53.84a5.073 5.073 0 005.074 5.074H50.91a5.074 5.074 0 005.074-5.074V20.317L37.081.008H5.135z" fill-rule="evenodd" clip-rule="evenodd" fill="#FF5D2D"></path>
 ...
 <g fill-rule="evenodd" clip-rule="evenodd">
  <path d="M55.976 20.352v1H43.177s-6.312-1.26-6.129-6.707c0 0 .208 5.707 6.004 5.707h12.924z" fill="#D83A00"></path>

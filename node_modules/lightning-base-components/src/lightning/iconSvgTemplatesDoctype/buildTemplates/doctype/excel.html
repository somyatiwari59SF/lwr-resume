<template>
    <svg class={computedClass} focusable="false" data-key={name} aria-hidden="true" viewBox="0 0 56 64" part="icon">
        <g>
 <path d="M5.112.006A5.074 5.074 0 00.039 5.08v53.841a5.073 5.073 0 005.073 5.074h45.774a5.074 5.074 0 005.074-5.074V20.316L37.058.006H5.112z" fill-rule="evenodd" clip-rule="evenodd" fill="#2E844A"></path>
 ...
 <path d="M55.953 20.352v1H43.152s-6.312-1.26-6.127-6.707c0 0 .207 5.707 6.002 5.707h12.926z" fill-rule="evenodd" clip-rule="evenodd" fill="#194E31"></path>
 <path d="M37.049 0v14.561c0 1.656 1.104 5.791 6.104 5.791h12.801L37.049 0z" fill-rule="evenodd" clip-rule="evenodd" fill="#CDEFC4"></path>
</g>
    </svg>
</template>

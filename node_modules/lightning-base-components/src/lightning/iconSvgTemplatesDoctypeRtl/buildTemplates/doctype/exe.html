<template>
    <svg class={computedClass} focusable="false" data-key={name} aria-hidden="true" viewBox="0 0 56 64" part="icon">
        <g>
 <path d="M5.112.025A5.074 5.074 0 00.039 5.099V58.94a5.073 5.073 0 005.073 5.074h45.774a5.074 5.074 0 005.074-5.074V20.335L37.058.025H5.112z" fill-rule="evenodd" clip-rule="evenodd" fill="#747474"></path>
 ...
 <g fill-rule="evenodd" clip-rule="evenodd">
  <path d="M55.961 20.377v1H43.162s-6.312-1.26-6.129-6.708c0 0 .208 5.708 6.004 5.708h12.924z" fill="#5C5C5C"></path>
  <path d="M37.059.025v14.561c0 1.656 1.104 5.792 6.104 5.792h12.799L37.059.025z" fill="#C9C9C9"></path>
 </g>
</g>
    </svg>
</template>

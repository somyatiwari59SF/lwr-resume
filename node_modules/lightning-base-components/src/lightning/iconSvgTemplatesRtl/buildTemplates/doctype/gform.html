<template>
    <svg class={computedClass} focusable="false" data-key={name} aria-hidden="true" viewBox="0 0 56 64" part="icon">
        <g>
 <path fill="#5A1BA9" d="M5.1 0C2.3 0 0 2.2 0 5v53.9C0 61.7 2.3 64 5.1 64h45.8c2.8 0 5.1-2.3 5.1-5.1V20.3L37.1 0h-32z"></path>
 <path fill="#300B60" d="M56 20.4v1H43.2s-6.3-1.3-6.2-6.8c0 0 .3 5.8 6.1 5.8H56z"></path>
 <path fill="#AD7BEE" d="M37.1 0v14.6c0 1.6 1.1 5.8 6.1 5.8H56L37.1 0z"></path>

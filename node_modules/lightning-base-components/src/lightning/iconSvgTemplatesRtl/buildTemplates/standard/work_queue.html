<template>
    <svg class={computedClass} focusable="false" data-key={name} aria-hidden="true" viewBox="0 0 100 100" part="icon">
        <g>
 <path d="M51.8 71.8c-1.1-.1-1.9-1-1.8-2v-4c0-1.1.9-2 2-2h25.9c1.1 0 2 .9 2 2v4c0 1.1-.9 2-2 2h-26-.1zm0-35.8c-1.1-.1-1.9-1-1.8-2v-4c0-1.1.9-2 2-2h25.9c1.1 0 2 .9 2 2v4c0 1.1-.9 2-2 2h-26-.1zM41.2 63.8l.2-.2c.6-.7.6-1.9-.2-2.6l-4.8-4.8c-.3-.2-.4-.6-.4-.9 0-.7.6-1.3 1.3-1.3h40.4c1.1-.1 2-.9 2.1-2v-4c0-1.1-1-2-2.1-2H37.5c-.3 0-.7-.2-.9-.4-.5-.5-.5-1.4 0-1.9l4.8-4.8.2-.2c.6-.7.6-1.9-.2-2.6l-2.8-2.8-.2-.2c-.7-.6-1.9-.6-2.6.2L20.5 48.6l-.2.2c-.6.7-.6 1.9.2 2.6l15.3 15.2c.7.7 1.9.7 2.6 0l2.8-2.8z"></path>
</g>
    </svg>
</template>

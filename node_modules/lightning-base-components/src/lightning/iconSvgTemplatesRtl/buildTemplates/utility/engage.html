<template>
    <svg class={computedClass} focusable="false" data-key={name} aria-hidden="true" viewBox="0 0 52 52" part="icon">
        <g>
 <path fill-rule="evenodd" d="M26.5 4.25c12.801 0 23.25 9.388 23.25 21.068 0 11.68-10.449 21.069-23.25 21.069-1.662 0-3.303-.158-4.9-.469l-.487-.101-.143.076c-2.032 1.04-5.305 1.882-9.913 2.597l-.517.08-1.128.162c-1.725.25-2.714-1.901-1.403-3.049 1.315-1.15 2.314-2.66 2.998-4.555l.025-.077-.317-.26c-4.595-3.848-7.338-9.241-7.46-15.066l-.005-.407C3.25 13.638 13.699 4.25 26.5 4.25zm7 26.75h-14a2 2 0 100 4h14a2 2 0 100-4zm4-7.5h-22a2 2 0 100 4h22a2 2 0 100-4zm-4-7.5h-14a2 2 0 100 4h14a2 2 0 100-4z"></path>
</g>
    </svg>
</template>

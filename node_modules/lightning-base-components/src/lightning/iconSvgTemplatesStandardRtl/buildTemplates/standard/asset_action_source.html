<template>
 ...
 <path d="M55.5 68a12.1 12.1 0 0012.1 11.9 12 12 0 0011.9-12 12 12 0 10-24 .1zm3.9-.5l5.3-5.5a.67.67 0 011 0l1 1a.67.67 0 010 1l-1.6 1.5a.46.46 0 00.3.8h9.7a.68.68 0 01.7.7v1.5a.75.75 0 01-.7.7h-9.7a.45.45 0 00-.3.8l1.6 1.7a.67.67 0 010 1 11 11 0 01-1 1.1.67.67 0 01-1 0l-5.3-5.4a.56.56 0 010-.9z"></path>
</g>
    </svg>
</template>

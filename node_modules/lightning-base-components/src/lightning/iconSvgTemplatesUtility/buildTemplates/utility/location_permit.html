<template>
    <svg class={computedClass} focusable="false" data-key={name} aria-hidden="true" viewBox="0 0 52 52" part="icon">
        <g>
 <path d="M39.18 11.4l-9.12-9.12a1.1 1.1 0 00-.71-.28 1 1 0 00-1 1v7.26A2.71 2.71 0 0031.06 13h7.26a1 1 0 001-1c.14-.17.14-.31-.14-.6zm.28 7.26A1.42 1.42 0 0038 17.24h-9.65a4.13 4.13 0 01-4.13-4.13V3.42A1.42 1.42 0 0022.8 2H9a4.13 4.13 0 00-4.15 4.13v33.19A4.13 4.13 0 009 43.45h14.1c1.14 0 1.42-.71 1.28-2a13.94 13.94 0 013-10.25c3.42-4 9.12-4.27 10-4.27s2.28 0 2.14-1.29zm-29.77-8l3.42-.43a.14.14 0 00.14-.14L14.82 7a.42.42 0 01.57 0L17 10.12l.14.14 3.42.43a.28.28 0 01.14.43l-2.57 2.56V14l.57 3.42c0 .15-.14.43-.42.29l-3-1.57H15l-3 1.57c-.14.14-.43 0-.43-.29L12 14v-.28l-2.59-2.46a1.09 1.09 0 01.28-.57zm12.54 23.25a1.43 1.43 0 01-1.43 1.42h-9a1.43 1.43 0 01-1.43-1.42v-1.43a1.43 1.43 0 011.43-1.42h9a1.43 1.43 0 011.43 1.42zm7.54-8.41a1.43 1.43 0 01-1.42 1.43H11.83a1.43 1.43 0 01-1.43-1.43v-1.42a1.43 1.43 0 011.43-1.43h16.66a1.43 1.43 0 011.43 1.43v1.42zM37.32 37a2 2 0 102 2 2.14 2.14 0 00-2-2z"></path>
 <path data-name="Shape" d="M37.32 30.34a9.83 9.83 0 109.83 9.83 10 10 0 00-9.83-9.83zM37.61 46a.44.44 0 01-.61 0c-1-.85-4.42-3.7-4.42-7A4.7 4.7 0 0142 39c-.12 3.31-3.39 6.16-4.39 7z"></path>
</g>
    </svg>
</template>

...
export declare class BucketHistogramImpl implements BucketMetric<number[]>, BucketHistogram {
    ...
    private _values;
    constructor(_name: string, _ownerName: string, _ownerAppName: string, _tags: MetricsTags, _buckets: number[], createdOn?: number, lastUpdatedOn?: number, values?: number[]);
    getName(): string;
    getCreatedOn(): number;
